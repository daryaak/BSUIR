...
Turism Turism::operator=(const Turism& obj)
{
...
char* Turism::GetPlaces() { return this->places; }
void Turism::SetPlaces(char* a)
{

    strcpy_s(this->places, LEN, a);
}

Turism Turism::PickField()
{

    Turism tmp;
    cout << "Выберите параметр для сортировки" << endl << "1.Страна" << endl << "2.Город" << endl << "3.Дата отправления"<< endl
        << "4.Трансп. компания" << endl << "5.Количество дней"<< endl << "6.Кол-во свободных мест" << endl;
    cout << "7.Цена тур агенства" << endl << "8.Название отеля" << endl << "9.Специфика тура" << endl << "10.ID " << endl;
    int a = InputInt(1, 10);
    switch (a)
    {
    case 1:
    ...
    case 9:
    {
        strcpy_s(tmp.places, LEN, this->places);
        break;
    }
    case 10:
    {
...
ifstream& operator>>(ifstream& in, Turism& obj)
{
    in >> dynamic_cast<Travel&>(obj);
    in.getline(obj.places, 80, '|');
    in.clear();
    in >> obj.ID;
    return in;
}
ofstream& operator<<(ofstream& out, Turism& obj)
{
    out << dynamic_cast<Travel&>(obj);
    out.setf(ios::left);
    out << setw(20) << obj.places <<'|'<< setw(20) << obj.ID << setw(20) << endl;
    out.unsetf(ios::left);
    return out;
}

bool Turism::operator==(const Turism& obj)
{
    ...
    if (strlen(obj.places))
        if (strncmp(places, obj.places, strlen(obj.places))) return false;
    return true;
}

bool Turism::operator<(Turism& obj)
{
    if (strlen(obj.Country))
   ...
   if (strlen(obj.TransCom))
    ...
    if (strlen(obj.places))
        if (strcmp(this->places, obj.places) > 0) return false;
    return true;
}
...
void Turism::ReplaceField(Turism& obj)
{
    ...
    if (strlen(this->places))
        strcpy_s(this->places, LEN, obj.places);
}
istream& operator>>(istream& is, Turism& obj)
{
    rewind(stdin);
    is >> dynamic_cast<Travel&>(obj);
    cout << "Введите специфику тура: ";
    rewind(stdin);
    char* tmp = InputRussian();
    strcpy_s(obj.places, LEN, tmp);
    delete tmp;
    return is;
}
ostream& operator<<(ostream& out, Turism& obj)
{
    out << dynamic_cast<Travel&>(obj);
    out.setf(ios::left);
    out << setw(20)<< obj.places << setw(20) << obj.ID << setw(20) << endl;
...
void Turism::HeadOfSheet()
{
    cout.setf(ios::left);
    cout << setw(5) << "№" << setw(20) << "Страна" << setw(20) << "Город" << setw(20) << "Дата отправления"<< setw(20) << "Трансп. компания"
        << setw(20) << "Количество дней"<< setw(20) << "Кол-во свобод. мест";
    cout << setw(20) << "Цена" << setw(20) << "Название отеля";
    cout << setw(20) << "Специфика тура"<< setw(20) << "ID" << endl;
...
void Turism::Find()
{
    ...
    do
    {
        cout << "Выберите параметр для поиска" << endl << "1.Страна" << endl << "2.Город" << endl << "3.Дата отправления"<< endl << "4.Трансп. компания" << endl << "5.Количество дней"<< endl << "6.Количество свободных месь" << endl;
        cout << "7.Цена тур агенства" << endl << "8.Название отеля" << endl << "9.Специфика тура" << endl << "10.ID " << endl<< "11.Выход " << endl;
        int a = InputInt(1, 11);
        switch (a)
        {
        case 1:
        ...
        case 3:
        {
            ...
            tmp = InputDate();
            strcpy_s(this->DateOfDeparture, 11, tmp);
            cout << endl;
            break;
        }
        case 4:
        {
            rewind(stdin);
            cout << "Введите трансп. комп: ";
            tmp = InputDate();
            strcpy_s(this->TransCom, 11, tmp);
            cout << endl;
            break;
        }
        case 5:
...
void Turism::Change()
{
    ...
    do
    {
        cout << "Выберите параметр для редактирования" << endl << "1.Страна" << endl << "2.Город" << endl << "3.Дата отправления" << endl<< "4.Трансп. компания" << endl
            << "5.Количество дней"<< endl << "6.Количество свободных мест" << endl;
        cout << "7.Цена тур агенства" << endl << "8.Название отеля" << endl << "9.Специфика тура" << endl << "10.ID "<< endl << "11.Выход " << endl;
        int a = InputInt(1, 10);
        switch (a)
        {
